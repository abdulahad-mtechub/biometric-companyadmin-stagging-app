...
const WorkerFilterBtmSheet = forwardRef(
  (
    {
      onApplyFilters,
      showPicker = false,
    ...
    const departments = useSelector(state => state.states.departments);
    ...
    const handleApplyFilters = useCallback(() => {
      ...
      // Format salary range as "start-end"
      const salaryRange =
        salaryStart > 0 || salaryEnd > 0 ? `${salaryStart}-${salaryEnd}` : null;
        ...
        <ScrollView
          ...
          {selectedTab === 'Employees' && (
            <>
              ...
              <View style={styles.section}>
                <Text style={styles.sectionTitle}>{t('Select Shift')}</Text>
                <CustomDropDown
                  data={shiftOptions}
              ...
              <View style={styles.section}>
                <Text style={styles.sectionTitle}>{t('Salary Range')}</Text>
                <View style={styles.salaryRow}>
                  <View style={styles.salaryInputContainer}>
                    <Text style={styles.inputLabel}>{t('Start')}</Text>
                    <NumericStepper
                      value={salaryStart}
                      setValue={setSalaryStart}
                      min={0}
                      max={100000}
                    />
                  </View>
                  ...
                  <View style={styles.salaryInputContainer}>
                    <Text style={styles.inputLabel}>{t('End')}</Text>
                    <NumericStepper
                      value={salaryEnd}
                      setValue={setSalaryEnd}
                      min={0}
                      max={100000}
                    />
                  </View>
...
export default WorkerFilterBtmSheet;
