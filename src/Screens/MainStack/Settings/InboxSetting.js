...
const WorkerSetting = ({navigation}) => {
  ...
  // === INBOX SETTINGS STATES ===
  const [hodCanCreateGroups, setHodCanCreateGroups] = useState(true);
  const [teamLeadCanCreateGroups, setTeamLeadCanCreateGroups] = useState(true);
  ...
  const sections = [
    {
      title: null, // Inbox Settings section without explicit title
      data: [
        {
          label: t('HOD can create the groups'),
          value: hodCanCreateGroups,
          onToggle: () => setHodCanCreateGroups(!hodCanCreateGroups),
          type: 'switch'
        },
        {
          label: t('Team lead can create groups'),
          value: teamLeadCanCreateGroups,
          onToggle: () => setTeamLeadCanCreateGroups(!teamLeadCanCreateGroups),
          type: 'switch'
        },
      ],
    },
  ...
  const addButtonSections = [
    // Removed add button sections to match the image
  ];
