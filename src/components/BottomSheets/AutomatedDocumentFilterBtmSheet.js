...
export default function AutomatedDocumentFilterBtmSheet({
  refRBSheet,
  onApplyFilters,
  height = hp(35),
  isHistory = false,
  ...
  const handleApplyFilters = useCallback(() => {
    onApplyFilters({
      ...
      documentType: selectedDocumentType?.value || null,
    });
  ...
  const categories = useMemo(
    () => [
      {label: t('Employement Certificate'), value: 'employment_certificate'},
      {label: t('Payslip'), value: 'payslip'},
    ],
    [t],
  );
