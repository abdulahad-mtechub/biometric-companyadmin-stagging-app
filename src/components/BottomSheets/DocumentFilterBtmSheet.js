...
export default function DocumentFilterBtmSheet({
  refRBSheet,
  onApplyFilters,
  isWorkerReceivesTab,
  height = hp(35),
  ...
  const handleApplyFilters = useCallback(() => {
    onApplyFilters({
      ...
      sortOrder: selectedSortOrder?.value || null,
    });
  ...
  const sortByOptions = useMemo(
    () => [
      {label: t('Created Date'), value: 'created_at'},
      {label: t('Updated Date'), value: 'updated_at'},
      {label: t('Document Name'), value: 'document_name'},
      {label: t('Category'), value: 'category'},
      {label: t('Status'), value: 'status'},
      {label: t('File Type'), value: 'file_type'},
    ],
    [t],
  );
  ...
  return (
    <RBSheet
      ...
      <ScrollView
        ...
        {isWorkerReceivesTab && workers.length > 0 && (
          ...
          <>
            ...
            <View style={styles.section}>
              ...
              <CustomDropDown
                ...
                placeholder={t(`Select Sort By`)}
                search={false}
              />
            </View>

            <View style={styles.section}>
              <Text style={styles.sectionTitle}>{t('Sort Order')}</Text>
              <CustomDropDown
